    ...
    <div className="space-y-8">
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel>
              What gap exists between your daily habits and the leader you aspire to become?
            </FormLabel>
            <FormControl>
              <Textarea
            ...
            <FormDescription>
              Consider specific habits you could develop or change
            </FormDescription>
          </FormItem>
        )}
      />
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel>
              When was the last time you led from a place of discomfort? What did you learn?
            </FormLabel>
            <FormControl>
              <Textarea
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel>
              Who challenges you to be better, and how do you respond to their feedback?
            </FormLabel>
            <FormControl>
              <Textarea
            ...
            <FormDescription>
              Strong leaders seek and value constructive criticism
            </FormDescription>
          </FormItem>
        )}
      />
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormDescription>
              Define the mark you want to leave
            </FormDescription>
          </FormItem>
        )}
      />
